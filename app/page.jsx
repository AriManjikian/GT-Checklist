...
const CourseTracker = () => {
  ...
  const requirements = [
    ...
    },
    {
      ...
      minCredits: 15,
      courses: [
        { code: "PHYS_ELECTIVE", name: "Any PHYS course", credits: 3, flexible: true },
        ...
        { code: "MATH 2106", name: "Foundations of Mathematical Proof", credits: 3 },
        { code: "MATH 3215", name: "Introduction to Probability and Statistics", credits: 3 },
        { code: "MATH 3235", name: "Probability Theory", credits: 3 },
        { code: "MATH 4320", name: "Advanced Calculus I", credits: 3 },
        { code: "MATH 4347", name: "Partial Differential Equations", credits: 3 },
        { code: "MATH 4348", name: "Differential Geometry", credits: 3 },
        { code: "MATH 4581", name: "Abstract Algebra I", credits: 3 },
        { code: "NRE 3301", name: "Nuclear and Radiological Engineering and Science", credits: 3 },
                    ...
                    {category.courses.map((course, courseIndex) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`w-5 h-5 rounded border-2 flex items-center justify-center ${completedCourses[course.code]
